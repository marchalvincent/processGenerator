...
public class UmlImplicitTerminationTest {
	...
	public void test1() throws Exception {
		...
		StructuralConstraintChecker checker = new StructuralConstraintChecker(new UmlImplicitTermination(), EQuantity.EQUAL, 0);
