...
public class UmlParallelSplitTest {
	...
	public void test0() throws Exception {
		...
		StructuralConstraintChecker checker = new StructuralConstraintChecker(new UmlParallelSplit(), EQuantity.EQUAL, -1);
	...
	public void test1() throws Exception {
		...
		StructuralConstraintChecker checker = new StructuralConstraintChecker(new UmlParallelSplit(), EQuantity.EQUAL, 0);
