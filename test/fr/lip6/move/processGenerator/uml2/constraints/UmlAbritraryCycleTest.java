...
public class UmlAbritraryCycleTest {
	...
	public void test1() throws Exception {
		...
		StructuralConstraintChecker checker = new StructuralConstraintChecker(new UmlArbitraryCycle(), EQuantity.EQUAL, 0);
	...
	public void test5() throws Exception {
		...
		// init du workflow checker
		StructuralConstraintChecker checker = new StructuralConstraintChecker(new UmlArbitraryCycle(), EQuantity.EQUAL, 2);
		assertTrue(checker.check(process));
	}
}
