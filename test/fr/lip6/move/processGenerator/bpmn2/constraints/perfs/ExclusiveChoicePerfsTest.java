...
import fr.lip6.move.processGenerator.bpmn2.constraints.impl.BpmnExclusiveChoiceOcl;
...
public class ExclusiveChoicePerfsTest {
	...
	public void testOCL() throws Exception {
		...
		// Java
		IStructuralConstraint c1 = new BpmnExclusiveChoiceOcl();
		this.test(c1, "OCL", false);
		this.test(c1, "OCL", true);
		
		IStructuralConstraint c2 = new BpmnExclusiveChoice();
