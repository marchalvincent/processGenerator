...
public abstract class AbstractStructuralConstraintFactory {
	...
	/**
	 * La création de workflow pattern est la même pour chaque type de fichier, c'est pourquoi le code
	 * est dans cette classe abstraite.
	 * @param eBpmnWorkflowPattern cet objet doit être une {@link IEnumWorkflowPattern}. Ainsi il pourra instancier le workflow.
	 ...
	 * @param query String, la requete écrite à la main.
	 ...
	 * @param eElement Cet objet doit être une {@link IEnumElement}.
	 * @return {@link IStructuralConstraint}.
	 * @throws Exception si l'élément n'est pas du même type que le fichier qu'on évalue.
	 */
