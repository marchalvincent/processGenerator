...
/**
 * Permet l'insertion d'un nouveau thread de terminaision implicite au process. Le thread se termine par un {@link FlowFinalNode}.
 * 
 * @author Vincent
 *
 ...
 */
public class UmlThreadInsertImplicit extends AbstractChangePattern<UmlProcess> {

	// pour éviter trop d'instanciation de cette même classe
	public static UmlThreadInsertImplicit instance = new UmlThreadInsertImplicit();
