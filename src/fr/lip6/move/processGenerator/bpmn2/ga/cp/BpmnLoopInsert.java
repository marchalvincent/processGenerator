...
/**
 * Ce change pattern est chargé d'ajouter une boucle au candidat donné. La boucle est implémentée avec des gateways
 * exclusives.
 * 
 * @author Vincent
 * 
 */
public class BpmnLoopInsert extends AbstractChangePattern<BpmnProcess> {
