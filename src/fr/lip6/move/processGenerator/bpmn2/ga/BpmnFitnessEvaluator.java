...
/**
 * L'évaluateur d'un candidat. C'est une fonction de fitness "naturelle", c'est à dire que plus la valeur de la fitness
 * est élevée, plus le candidat correspond aux attentes.
 * 
 * @author Vincent
 * 
 */
public class BpmnFitnessEvaluator implements FitnessEvaluator<BpmnProcess> {
	 ...
	 * @return double la valeur defitness correspondant aux contraintes vérifiées sur le candidat. La valeur est entre 0
	 *         et 1.
	 */
