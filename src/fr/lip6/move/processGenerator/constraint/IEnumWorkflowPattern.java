...
/**
 * Représente le comportement que doit avoir une énumération de workflow pattern. Chaque énumération
 * se voit attribué une classe représentant la contrainte du workflow pattern.
 * @author Vincent
 *
 */
public interface IEnumWorkflowPattern {
	 ...
	 * @throws Exception lorsque l'instanciation à échouée.
	 */
